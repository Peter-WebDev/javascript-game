...
function sceneMainOne() {
    ...
    west.onclick = sceneForestOne;
    east.onclick = sceneCaveOne;
};

/** Scene Alt Main One */
function sceneAltMainOne() {
...
function sceneForestOne() {
    ...
    west.onclick = sceneForestDeath;
    east.onclick = sceneAltMainOne;
    south.onclick = sceneForestTwo;
}

/** Scene Cave One */
function sceneCaveOne() {
    storyImage.src = 'https://picsum.photos/id/168/800/600.webp';
}

/** Scene Forest Death */
function sceneForestDeath() {
